<?php
/**
 * Import RSS Feed into an Existing Table (Test Script)
 * Fetches articles from a sample RSS feed (BBC News) and inserts them into your MySQL table.
 */
...
// RSS Feed URL (Using BBC News Feed)
...
echo '<p>RSS Feed imported successfully!</p>';
?>